...
import (
	...
	"github.com/abdullah599/PodReaper/internal/controller"
...
func init() {
	...
	utilruntime.Must(podreapercomv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "14fee5ff.podreaper.com",
	...
	if err = (&controller.PodReaperConfigReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "PodReaperConfig")
		os.Exit(1)
	}
